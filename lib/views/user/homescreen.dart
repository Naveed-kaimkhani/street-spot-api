      ...
      body: SingleChildScrollView(
        child: Padding(
            ...
            child: Obx(() {
              ...
              final recommendedTrucks =
                  controller.customerDashboardData.value!.recommendedTrucks;
              final mapTrucks =
                  controller.customerDashboardData.value!.mapTrucks;
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment
                        .spaceBetween, // To space out the elements
                    children: [
                      GestureDetector(
                        onTap: () {
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: Colors
                                    .grey[200], // Background color of circle
                              ),
                              child: Icon(
                      ...
                      ? SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return UserDashboardMenuWidget(
                  ...
                  SizedBox(height: 12.h),
                  mapTrucks.isNotEmpty
                      ? SizedBox(
                          height: 180.h,
                          child: ListView.builder(
                            scrollDirection: Axis.horizontal,
                            itemCount: mapTrucks.length,
                            itemBuilder: (context, index) {
...
class UserDashboardMenuWidget extends StatelessWidget {
  const UserDashboardMenuWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      margin: EdgeInsets.only(right: 12.w), // Space between cards
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Stack(
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, galleryIndex) {
                final imagePath = restaurant.galleryImages[galleryIndex];
                return Container(
                  ...
                  child: galleryIndex == restaurant.galleryImages.length - 1
                      ? Center(
                          child: Text(
                            'More+',
                            style: TextStyle(
            ...
            children: [
              ...
              Padding(
                ...
                child: CustomButton(
                  ...
                  onTap: () {
                    Get.toNamed(AppRouteName.Store_SCREEN_ROUTE);
